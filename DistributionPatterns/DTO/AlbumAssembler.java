...
import ObjectRelationalStructural.DependentMapping.Track;
import ObjectRelationalStructural.ForeignKeyMapping.SingleValueReference.Album;
...
public class AlbumAssembler {
    ...
    private void writeTracks(AlbumDTO result, Album subject) {
        List<E> newTracks = new ArrayList<>();
